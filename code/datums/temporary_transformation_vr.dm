...
/datum/temporary_transformation
	...
	/// The mob to whom the transformation belongs.
	var/mob/living/carbon/human/owner

	/// The ckey of the player to whom this transformation was initially given.
	var/ckey

	/// Whether or not the TF is currently in the process of transforming or reverting a transformation.
...
/// Returns the location of this transformation's alternate form.
/datum/temporary_transformation/proc/get_temp_form_location()
...
/// Transformations may cause the owner to be released in some way,
...
/// Attempts to find a type of temporary transformation that this mob is capable of, (See `temporary_forms` in mob_defines_vr.dm).
