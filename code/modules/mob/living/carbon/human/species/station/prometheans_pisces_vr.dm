var/datum/species/shapeshifter/promethean/water/pisces_prometheans

// Species definition follows.
/datum/species/shapeshifter/promethean/water

	name =             SPECIES_PROMETHEAN_WATER
	name_plural =      "Pisces Prometheans"
	blurb =            "Pisces Prometheans be made of water n' shit lol"
	catalogue_data = list(/datum/category_item/catalogue/fauna/promethean)
	show_ssd =         "totally quiescent"
	death_message =    "rapidly loses cohesion, splattering across the ground..."
	knockout_message = "collapses inwards, forming a disordered puddle of water."
	...
	mob_size =         MOB_SMALL
	bump_flag =        WATER
	swap_flags =       MONKEY|WATER|SIMPLE_ANIMAL
	push_flags =       MONKEY|WATER|SIMPLE_ANIMAL
	...
	blood_volume =	560
	brute_mod =		0.75
	burn_mod =		1.25 // They don't burn as bad as prommies, but a part of their body still evaporates!
	oxy_mod =		0
	...
	rarity_value = 8 // They're a niche mutation of an already oddball and niche species!
	siemens_coefficient = 0.8

	water_resistance = 1 // THEY ARE LITERALLY FUCKING MADE OF WATER
	water_damage_mod = 0 // see above
