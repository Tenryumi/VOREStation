var/datum/planet/amita/planet_amita = null
...
/datum/planet/amita
	name = "Amita"
	desc = "Flavor text that Jenny forgot to write aw FUCK HELP AAAAAAAAAAAAAAA"
	current_time = new /datum/time/amita()
//	expected_z_levels = list(1) // This is defined elsewhere.
	planetary_wall_type = /turf/unsimulated/wall/planetary/amita

/datum/planet/amita/New()
	..()
	planet_amita = src
	weather_holder = new /datum/weather_holder/amita(src)

/datum/planet/amita/update_sun()
	..()
...
/datum/weather/amita/light_snow
	name = "light snow"
...
/datum/weather/amita/storm/proc/handle_lightning()
...
/datum/weather/amita/hail/process_effects()
	..()
...
/datum/weather/amita/ash_storm/process_effects()
	..()
...
/datum/weather/amita/fallout/process_effects()
	..()
	for(var/thing in living_mob_list)
		var/mob/living/L = thing
		if(L.z in holder.our_planet.expected_z_levels)
...
/datum/weather/amita/fallout/proc/irradiate_nearby_turf(mob/living/L)
	if(!istype(L))
		return
