...
/obj/item/bluespaceradio/sd_prelinked
	name = "bluespace radio (Aoi)"
	handset = /obj/item/radio/bluespacehandset/linked/aoi_prelinked

/obj/item/radio/bluespacehandset/linked/aoi_prelinked
	bs_tx_preload_id = "aoi_rx" //Transmit to a receiver
	bs_rx_preload_id = "aoi_tx" //Recveive from a transmitter
